...
if (projectId && projectId !== 'aicoco-5f8e6') {
  console.log(`⚠️  프로젝트 ID가 'aicoco-5f8e6'가 아닙니다: ${projectId}`);
}
...
if (missingVars.length === 0 && invalidVars.length === 0) {
  ...
  console.log('2. aicoco-5f8e6 프로젝트 선택');
...
console.log('3. https://aicoco-5f8e6.web.app 에서 확인');