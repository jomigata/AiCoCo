    ...
    <footer className="bg-gray-800 text-gray-300 pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex">
              <input 
                ...
                className="bg-gray-700 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent w-full text-sm"
              />
              <button className="bg-primary text-white px-4 py-2 rounded-r-md text-sm font-medium hover:bg-opacity-90 transition-colors">구독</button>
            </div>
          </div>
          ...
          {/* 회사 정보 */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">심리케어</h3>
            <ul className="text-sm space-y-2">
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-sm text-gray-500">&copy; 2025 심리케어. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
